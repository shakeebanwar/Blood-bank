...
function BloodRequestDashboard(props) {
    ...
    useEffect(async () => {
        ...
        axios.get('http://bloodbankapp.pythonanywhere.com/AllBloodRequests')
    ...
    console.log("my data ===> ", allbloodrequest)
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <GlobalHead arrowstatus={true} headTitle={"All Blood Request"} redirect={() => props.navigation.goBack()} />
            <ScrollView>
                <FlatList
